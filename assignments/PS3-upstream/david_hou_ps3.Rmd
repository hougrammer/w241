...
**The treatment is unlikely to have any effect on whether people obtain cell phones, so in that sense, it is not bad conctrol.  However, not having a cell phone precludes a person from receiving the SMS message.  In this sense, it is a bad control because having a cell phone is heavily correlated with being in teh treatment group.**
