...
(co = coeftest(m))
```
**The regression shows an effect of `r round(co[2,1], 2)` (`r round(co[2,2], 2)`).  The effect is statistically significant.**
...
**The evidence is convincing of plate size effecting the quantity of people eat but says nothing about weight loss.**

- What design and measurment improvements do you suggest?

**The design could be improved to a longer term study in which people are randomly assigned different sized plates over several meals.  Then, we can see if the effect lasts long enough over time to actually produce changes in weight.**
